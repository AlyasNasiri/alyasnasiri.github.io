const VERSION='6139d0e59fc0f856';
const CACHE='alyas-nasiri-'+VERSION;
const FILES=["./index.html","./app.mjs","./style.css","./content.mjs","./engine.mjs","./engine-client.mjs","./engine-worker.mjs","./keyboard.json","./special-letters.json","./word-lookup.mjs","./word-data.json","./updates.mjs","./vendor/find-replace.js","./vendor/text.js","./fonts/BurushaskiNaskh.woff2","./fonts/BurushaskiNastaliq.woff2","./fonts/FONT-OFL.txt","./manifest.webmanifest","./icon.svg","./404.html"];
